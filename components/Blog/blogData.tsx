...
const BlogData: Charity[] = [
  {
    ...
    title: "Play2MagicWorld World Water Aid",
    metadata:
      "Play2MagicWorld, an innovative platform where gaming meets social impact. Designed to bring entertainment and purpose together, Play2MagicWorld allows users to play exciting games, earn coins, and contribute to meaningful social causes.",
  },
  {
    ...
    title: "Play2MagicWorld World WWF",
    metadata:
      "Play2MagicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Play2MagicWorld World MSF Doctors Without Borders",
    metadata: "Play2MagicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Play2MagicWorld Cancer Research",
    metadata: "Play2MagicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Play2MagicWorld Alzheimer's Society",
    metadata: "Play2MagicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Play2MagicWorld Red Cross",
    metadata: "Play2MagicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
];
